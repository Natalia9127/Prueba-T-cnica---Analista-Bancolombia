...
public class ChoucairAcademyStepDefintions {
    ...
    public void thanNataliaWantToLearnAutomationAtTheAcademyChoucair(List<AcademyChoucairData> academyChoucairData) throws Exception {
        OnStage.theActorCalled( "Natalia").wasAbleTo(OpenUp.thePage(), Login.
